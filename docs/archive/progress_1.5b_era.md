# Training Pipeline Progress — 1.5B Era (ARCHIVED)

> **Status:** Historical record of SFT v3, SFT v5, and RL runs 1-3 on Qwen2.5-1.5B
> on the 12 GiB TITAN X Pascal. Superseded by Qwen3-14B work on the Blackwell box
> (see `PROGRESS.md`). Kept for failure-mode analysis and conclusions that informed
> the 14B switch. References to `rl_runs/`, `sft_output/`, `rl_dashboard.png` etc.
> may be stale or removed.
> **Archived:** 2026-04-26
